  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-[880px] items-center justify-between rounded-full border border-white/10 bg-white/5 py-2 pr-2 pl-6 backdrop-blur-xl">
        ...
        <a
          href="#contact"
          className="rounded-full bg-mint px-5 py-2.5 font-semibold text-forest text-sm shadow-[0_0_24px_oklch(0.911_0.039_136.85_/_0.25)] transition-all duration-300 hover:shadow-[0_0_40px_oklch(0.911_0.039_136.85_/_0.45)]"
        >
          Inquire
        </a>
      </div>
    ...
    >
      ...
      <m.div style={{ opacity: reduce ? 1 : heroFade }} className="relative z-10 px-6 text-center">
        ...
        >
          <a
            href="#portfolio"
            className="rounded-full bg-mint px-9 py-4 font-semibold text-forest text-sm shadow-[0_0_32px_oklch(0.911_0.039_136.85_/_0.3)] transition-all duration-300 hover:shadow-[0_0_56px_oklch(0.911_0.039_136.85_/_0.5)]"
          >
    ...
    <section id="portfolio" className="scroll-mt-24 py-24 md:py-32">
      <div className="mx-auto max-w-6xl px-6">
        <Reveal className="flex flex-wrap items-end justify-between gap-6">
          ...
          <p className="font-tech text-[11px] text-cream/40 uppercase tracking-[0.25em]">
            Scroll →
          </p>
        </Reveal>
      </div>
  ...
  return (
    ...
    >
      ...
      <Reveal className="relative">
        ...
        <a
          href="#top"
          className="group mt-12 inline-flex items-center gap-3 rounded-full bg-mint px-10 py-5 font-semibold text-forest text-sm shadow-[0_0_40px_oklch(0.911_0.039_136.85_/_0.35)] transition-all duration-300 hover:shadow-[0_0_72px_oklch(0.911_0.039_136.85_/_0.55)]"
        >
  ...
  return (
    <footer className="border-white/10 border-t bg-gradient-to-b from-bark to-black px-6 pt-16 pb-10">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-8 text-center">
          ...
          {["Privacy Policy", "Terms of Service", "Ingredient Transparency", "Global Offices"].map(
            (l) => (
              <a
                key={l}
                href="#top"
                className="text-cream/40 text-xs uppercase tracking-[0.15em] transition-colors duration-300 hover:text-mint"
              >
                {l}
              </a>
            ),
        ...
        <p className="font-tech text-[10px] text-cream/25 uppercase tracking-[0.25em]">
