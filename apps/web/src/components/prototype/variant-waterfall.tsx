        ...
        {open && (
          ...
          >
            ...
            <div className="flex items-center justify-between border-t border-emerald-900/50 px-5 py-3">
              <span className="font-tech text-xs text-emerald-400/80">
...
function TickerSection() {
  ...
  return (
    <section
      ...
      className="border-y border-emerald-900/40 bg-[#020a06] py-4"
    >
...
function StatBand() {
  return (
    <section
      ...
      className="border-b border-emerald-900/40 bg-[#030e09] px-6 py-12"
    >
      <div className="mx-auto grid max-w-6xl grid-cols-2 gap-6 md:grid-cols-4">
        {STATS.map((st) => (
          <div key={st.unit} className="border-l-2 border-emerald-500/50 pl-5">
            ...
            <p className="mt-1 font-tech text-xs uppercase tracking-widest text-emerald-400">
              {st.unit}
            </p>
              ...
              {filtered.map((item) => (
                <tr key={item.code} className="transition hover:bg-emerald-950/30">
                  <td className="px-6 py-4">
                    <span className="font-tech text-[10px] text-emerald-500 block">
                      {item.code}
                    </span>
                    <span className="font-semibold text-white">{item.name}</span>
                  </td>
                  <td className="px-6 py-4 font-display italic text-emerald-300/80">
                    {item.latin}
                  </td>
        ...
        <div className="grid gap-8 lg:grid-cols-12 items-center rounded-2xl border border-emerald-900/60 bg-[#04140d] p-8 md:p-12">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4 border-y border-emerald-900/50 py-4 font-tech text-xs">
              <div>
                <span className="text-emerald-600 block uppercase tracking-wider">
                  Assay / Purity
                </span>
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {pillars.map((p) => (
            <div
              key={p.title}
              className="rounded-2xl border border-emerald-900/50 bg-[#04140d] p-8"
            >
          ...
          <div className="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6">
            {regions.map((reg) => (
              ...
              >
                ...
                <span className="mt-2 block font-tech text-[10px] text-emerald-600">
                  {reg.role}
                </span>
              </div>
            ))}
...
function FinaleSection() {
  return (
    <footer
      id="contact"
      className="relative border-t border-emerald-900/70 bg-[#020805] px-6 py-24 text-center"
    >
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mt-16 border-t border-emerald-900/50 pt-10 flex flex-wrap items-center justify-between gap-4 font-tech text-xs text-emerald-600">
          ...
          <div className="flex gap-6">
            <a href="#industries" className="hover:text-emerald-400">
              Industries
            </a>
            <a href="#matrix" className="hover:text-emerald-400">
              Portfolio
            </a>
            <a href="#standards" className="hover:text-emerald-400">
              Compliance
            </a>
            <a href="mailto:sales@fenchem.com" className="hover:text-emerald-400">
              sales@fenchem.com
            </a>
          </div>
        </div>
        ...
        <header className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between border-b border-emerald-900/40 bg-[#030e09]/85 px-6 py-3.5 backdrop-blur-md">
          <div className="flex items-center gap-6">
            ...
            <nav className="hidden md:flex items-center gap-6">
              ...
              <a
                href="#industries"
                className="text-sm text-emerald-200/80 transition hover:text-white"
              >
                Industries
              </a>
              <a href="#matrix" className="text-sm text-emerald-200/80 transition hover:text-white">
                Portfolio
              </a>
              <a
                href="#dossier"
